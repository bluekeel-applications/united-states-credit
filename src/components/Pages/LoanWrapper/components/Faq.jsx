...
const ITEMS = [
    ...
    { q: 'Will submitting the form affect my credit?', a: 'Submitting your initial request through UnitedStatesCredit and the initial matching process uses soft credit inquiries only and does not affect your credit score. If you choose to continue with a lender, that lender may request separate authorization for additional credit access, including a hard inquiry, which may affect your credit score.' },
