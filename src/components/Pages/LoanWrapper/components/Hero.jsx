...
// Hero: copy column + the lender form card (Bluekeel's own form, bkform). The
// {' '} between the h1 spans replaces .headline-lead:after{content:" "} —
// rendered when the spans are inline (>=760px), trimmed when they stack as
// blocks on mobile.
const Hero = ({ mockOnly }) => (
