    ...
    return(
        <div style={styles.mainConatiner}>
            <div style={styles.contentContainer}>
                <MainTitle text="How to Find the Right Credit Card for You"/>
                <div>
            ...
            <div style={styles.contentContainer}>
                <MainTitle text="Spending Habits and Rewards"/>
